...
local function mainScreen()
  ...
  background(color.gray)
  if FULLSIZE then
    gpu.set(MENUX+3, HEIGHT-11, "   Hologram Editor  v0.7.1-b1")
    foreground(color.fore)
...
if FULLSIZE then
  ...
  buttonNew(buttons, getHologram, MENUX+8, 29, loc.FROM_PROJECTOR, color.back, color.gold, 16)
