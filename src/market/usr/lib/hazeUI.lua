...
function hazeUI:list(title, text, list, callback, colorHeader, colorsList)
	colorHeader = {}
	...
	for i=1,#list do
		self:addButton(2, 6+(2*(i-1)), 70, 2, list[i], "hazeUI_list", colorsList[((i%2)+1)].fg, colorsList[((i%2)+1)].bg, "left", 
			function()
